---
name: comment-rules
description: Rules for adding and modifying comments in code. Use when Gemini CLI needs to add or update comments to ensure they focus on WHY/WHY NOT and follow the project's function header format.
---
